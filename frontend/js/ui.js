	...
	return `
		<div class="col-md-6 col-lg-4">
			<div class="card h-100 shadow-sm hover-shadow transition">
				<img src="${recipe.image || "https://images.pexels.com/photos/5190684/pexels-photo-5190684.jpeg"}" class="card-img-top" alt="${recipe.name}" style="max-height: 200px; object-fit: cover;">
